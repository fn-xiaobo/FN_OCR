...
//        Size pictureSize = mPictureSizes.sizes(mAspectRatio).last();
        ...
        Camera.Size currentSize = mCameraParameters.getPictureSize();
        if (currentSize.width>size.getWidth()||currentSize.height!=size.getHeight()) {
            ...
            if (mSettingPictureSize==null) {
                pictureSize=pictureSizeS.last();//选择最大的 Size
            }else{
            ...
            //设置帧率
//            mCameraParameters.setPreviewFrameRate(8);
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        camera.addCallbackBuffer(data);  //这里加这一句 解决内存溢出 https://blog.csdn.net/enjoyGai/article/details/78813347
        //todo 开始预览的时候添加加监听,获取实时图片流
        Log.d("fn_tag", "onPreviewFrame()获取实时图片流 --- 来之 camera1");
